...
##Pmod Header JA
##Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {TxDDebug}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {TxDDebug}]
###Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {transmitDebug}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {transmitDebug}]
###Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports {btnDebug}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {btnDebug}]
###Sch name = JA4
#set_property PACKAGE_PIN G2 [get_ports {clkDebug}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {clkDebug}]
##Sch name = JA7
